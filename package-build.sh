...
cp -r bower_components/bwt-datatable/src/* build/es6-unbundled/bower_components/bwt-datatable/src/
#cp -r bower_components/bwt-datatable/src/* build/es6-unbundled/bower_components-compiled/bwt-datatable/src/
