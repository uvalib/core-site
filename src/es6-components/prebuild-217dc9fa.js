...
class UvalibAlerts extends HTMLElement {
  ...
  _setupAlertsModel(){
    import ('./debounce-9d40488e.js').then(function (n) { return n.d; }).then(function(debounce){    
      import('./uvalib-model-alerts-17a89b09.js').then(function(){
...
uvalibAlertsRegionalStyles.replaceSync(css_248z$1);
document.adoptedStyleSheets = [...document.adoptedStyleSheets, uvalibAlertsRegionalStyles];

class UvalibAlertsRegional extends HTMLElement {
  ...
  _setupAlertsModel(){
    import ('./debounce-9d40488e.js').then(function (n) { return n.d; }).then(function(debounce){    
      Promise.resolve().then(function () { return uvalibModelRealtimeDatabase; }).then(function(){
  ...
  _matchesURL(pattern){
    ...
    for (var i=0; i<pattern.length; i++) {  
      ...
      if ( re.test(url.replace(/\/$/,'')) ) {return true}    }    return false;
  }
...
uvalibVizDonutStyles.replaceSync(css_248z$2);
